...
export function useTracBalances(address?: string) {
  ...
  const confirmed = useMemo(() => reduxBalances.confirmed || '0', [reduxBalances.confirmed]);
  const unconfirmed = useMemo(() => reduxBalances.unconfirmed || '0', [reduxBalances.unconfirmed]);
